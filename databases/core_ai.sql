...
COMMENT ON COLUMN public.completions.model
    IS 'string
Required
ID of the model to use. You can use the List models API to see all of your available models, or see our Model overview for descriptions of them.';

COMMENT ON COLUMN public.completions.prompt
    IS 'string or array
Optional
...
COMMENT ON COLUMN public.completions.suffix
    IS 'string
Optional
Defaults to null
The suffix that comes after a completion of inserted text.';

COMMENT ON COLUMN public.completions.max_tokens
    IS 'integer
Optional
Defaults to 16
...
COMMENT ON COLUMN public.completions.temperature
    IS 'number
Optional
Defaults to 1
...
COMMENT ON COLUMN public.completions.top_p
    IS 'number
Optional
Defaults to 1
...
COMMENT ON COLUMN public.completions.n
    IS 'integer
Optional
Defaults to 1
...
COMMENT ON COLUMN public.completions.stream
    IS 'boolean
Optional
Defaults to false
Whether to stream back partial progress. If set, tokens will be sent as data-only server-sent events as they become available, with the stream terminated by a data: [DONE] message.';

COMMENT ON COLUMN public.completions.logprobs
    IS 'integer
Optional
Defaults to null
...
COMMENT ON COLUMN public.completions.echo
    IS 'boolean
Optional
Defaults to false
Echo back the prompt in addition to the completion';

COMMENT ON COLUMN public.completions.stop
    IS 'string or array
Optional
Defaults to null
Up to 4 sequences where the API will stop generating further tokens. The returned text will not contain the stop sequence.';

COMMENT ON COLUMN public.completions.presence_penalty
    IS 'number
Optional
Defaults to 0
...
COMMENT ON COLUMN public.completions.frequency_penalty
    IS 'number
Optional
Defaults to 0
...
COMMENT ON COLUMN public.completions.best_of
    IS 'integer
Optional
Defaults to 1
...
COMMENT ON COLUMN public.completions.logit_bias
    IS 'map
Optional
Defaults to null
...
COMMENT ON COLUMN public.completions."user"
    IS 'string
Optional
...
(
    id bigserial NOT NULL GENERATED ALWAYS AS IDENTITY,
    name text NOT NULL GENERATED ALWAYS AS IDENTITY,
    email text,
...
DROP TABLE IF EXISTS completion.completion;
...
DROP TABLE IF EXISTS model.training;
...
DROP TABLE IF EXISTS "fine-tunning".sample;
...
DROP TABLE IF EXISTS "fine-tunning".summary;
